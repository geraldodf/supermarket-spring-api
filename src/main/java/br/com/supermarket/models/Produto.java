...
public class Produto {
    ...
    public void verificarProduto() throws Exception {
        ...
        if (this.codigoBarras < 0) {
            throw new ProductInvalidBarcodeException("O código está nulo.");
        }
        ...
        if (this.lucroLiquido == null) {
            throw new ProductProfitNullException("Lucro está nulo, houve problema.");
        }
        if (this.dataCriacao == null) {
            throw new ProductDateOfCreationNullException("Erro ao gerar a Data.");
        }
        ...
        if (this.precoVenda.subtract(this.precoCompra).doubleValue() != this.lucroLiquido.doubleValue()) {
            throw new ProductProfitInconsistentException("Valor do lucro está inconsistente.");
        }
    }
